/**
 * Guarantor relationship options used in Business & Guarantor Details step.
 *
 * NOTE: Stored on application.business_details.guarantors (JSON) as:
 * - relationship
 * - relationship_other (only when relationship === "others" for individual guarantors)
 */
...
export const GUARANTOR_COMPANY_RELATIONSHIP_LABELS: Record<
  GuarantorCompanyRelationship,
  string
> = {
