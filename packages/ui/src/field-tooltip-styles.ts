/** Same classes as issuer application-flow field tooltips (contract / financial steps). */
export const fieldTooltipContentClassName =
  "max-w-[240px] whitespace-pre-line bg-primary px-2 py-1.5 text-primary-foreground text-meta shadow-md";
