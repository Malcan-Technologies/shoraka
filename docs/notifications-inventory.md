...
Paymaster identity create, link, edit, verify, and Use Verified do **not** send typed notifications, platform inbox messages, or SES emails. Automatic notification count and direct email count are unchanged.
