...
| `KYB_APPROVED` | ~~SEED_ONLY~~ **DEAD** | — | — | — | — | — | — | — | — | No writer at all, including `seed.ts` — reclassified 2026-08-25, see §9 #13 |
...
| `KYB_APPROVED` | ~~SEED_ONLY~~ **DEAD** (corrected 2026-08-25 — confirmed zero occurrences in `seed.ts` too, unlike `KYC_STATUS_UPDATED`/`TNC_ACCEPTED`/`KYC_APPROVED`) | No writer anywhere, not even `seed.ts` | none — corporate approval flows through `ONBOARDING_APPROVED` |
