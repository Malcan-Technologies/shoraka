...
### File: `apps/admin/src/organizations/components/organization-detail-page.tsx`

(`apps/admin/src/components/organization-detail-page.tsx` re-exports this module.)
...
- Places that should switch to `people[]`:
  ...
  - `apps/admin/src/organizations/components/organization-detail-page.tsx` (organization Activity and CTOS/people cards).
