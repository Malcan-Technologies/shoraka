...
**Current tagged template:** 19 August 2026 LO (`arf_contract_facility_lo` **v1**, per-guarantor acknowledgement pages). Facility offers fill Part A; standalone invoice offers fill Part B.  
...
| ID  | Template location | Placeholder                         | Recommended fill       | Platform source                                                                                                             | Status   | Your decision | Notes                                                             |
| --- | ----------------- | ----------------------------------- | ---------------------- | --------------------------------------------------------------------------------------------------------------------------- | -------- | ------------- | ----------------------------------------------------------------- |
| G1  | Guarantor line 1  | `[INSERT NAME] (NRIC No. [INSERT])` | Individual guarantor 1 | `business_details.guarantors[]` where `guarantor_type === "individual"` → `name`, `ic_number` (also `ApplicationGuarantor`) | `EXISTS` | Agreed        | Lower-roman `i. ii. iii.`; empty slots print the placeholder |
