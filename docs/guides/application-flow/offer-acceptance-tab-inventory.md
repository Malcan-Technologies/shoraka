...
**Stage names (admin, after redesign):** Facility review · Customer review · Invoice review · Send offer · Issuer response · Acceptance documents · Signing package · Facility reference (existing_contract collapsed) · Inherited acceptance (existing_contract collapsed) · Merged notes.
