...
**Reserved/catalogued IDs:** 18 = original A039–A055 plus later-appended A175 (ONB-018 `ORGANIZATION_PROFILE_UPDATED_BY_ADMIN`). **Current active onboarding event types:** 15. **Retired / no current writer:** A040 `ONBOARDING_RESUMED`, A052 `CTOS_REPORT_RECEIVED`, A053 `CORPORATE_ENTITIES_UPDATED`. Historical rows remain readable. IDs are not reused. Overall audit catalogue is **178 reserved/catalogued IDs** (A001–A178), with **174 currently active event types** that have at least one writer (retired: A005 `ACTIVE_ROLE_CHANGED`, A040, A052, A053).
