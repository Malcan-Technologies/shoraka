...
| `CONTRACT_OFFER_ACCEPTANCE_SUBMITTED` | applications/service | ISSUER | Issuer submits Step 1 acknowledgements and acceptance documents |
...
| `INVOICE_OFFER_ACCEPTANCE_SUBMITTED` | applications/service | ISSUER | Issuer submits Step 1 acknowledgements and acceptance documents |
