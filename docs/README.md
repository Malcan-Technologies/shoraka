...
- **[ARF-i Letter of Offer placeholder map](./guides/application-flow/arf-letter-of-offer-placeholder-map.md)** - Contract-facility LOO fill map vs platform data (not invoice offers)
