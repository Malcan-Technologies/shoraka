...
Which button/action logs which event. Who did it. (previous) = existed at 1060399c, (new) = added after.
...
*APPLICATION_WITHDRAWN (new) also logged when all invoices withdrawn or contract withdrawn.*  
...
*Placeholder. Cron not yet implemented.*
