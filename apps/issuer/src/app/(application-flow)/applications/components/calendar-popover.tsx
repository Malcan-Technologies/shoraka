  ...
  return (
    <div className="w-[220px] rounded-lg border bg-card shadow-lg z-50">
      <div className="flex items-center gap-0.5 px-0.5 py-1 border-b">
        <button
          type="button"
          className="p-1 rounded shrink-0 transition-none focus-visible:outline-none focus-visible:ring-0"
        ...
        <div className="flex items-center gap-0.5 flex-1 min-w-0">
          ...
          >
            <SelectTrigger
              className="h-8 flex-1 min-w-0 px-1.5 text-xs border-0 shadow-none bg-transparent transition-none [&>span]:truncate focus-visible:outline-none focus-visible:ring-0 focus-visible:border focus-visible:border-primary data-[state=open]:border data-[state=open]:border-primary data-[state=open]:ring-0 data-[state=open]:outline-none"
              aria-label="Month"
            >
              <SelectValue />
            </SelectTrigger>
          ...
          >
            <SelectTrigger
              className="h-8 w-[4.25rem] shrink-0 px-1 text-xs border-0 shadow-none bg-transparent transition-none focus-visible:outline-none focus-visible:ring-0 focus-visible:border focus-visible:border-primary data-[state=open]:border data-[state=open]:border-primary data-[state=open]:ring-0 data-[state=open]:outline-none"
              aria-label="Year"
            >
              <SelectValue />
            </SelectTrigger>
