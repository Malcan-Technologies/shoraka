...
export default function InvestorSignupPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log("Investor signup form submitted", formData);
  };
  ...
  return (
    <div className={cn("flex flex-col gap-6")}>
            ...
            <FieldGroup>
              <div className="flex flex-col items-center gap-2 text-center">
                ...
                <p className="text-muted-foreground text-sm text-balance">
                  Join CashSouk and start earning returns on your investments
                </p>
              </div>
              ...
              <Field className="grid grid-cols-3 gap-4">
                <Button variant="outline" type="button" onClick={() => handleSocialSignup("Apple")}>
                ...
                <Button variant="outline" type="button" onClick={() => handleSocialSignup("Meta")}>
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="size-4">
                    <path
            ...
            <div className="absolute inset-0 flex items-center justify-center p-8">
              <div className="max-w-md space-y-6 text-center">
                ...
                <p className="text-muted-foreground text-balance">
                  Access verified borrowers and earn competitive returns on your investments with
                  CashSouk's secure P2P lending platform.
                </p>
              </div>
            </div>
          </div>
      ...
      <FieldDescription className="px-6 text-center">
        ...
        <Link href="/signup/borrower" className="text-primary hover:underline">
          Sign up as borrower
        </Link>
      </FieldDescription>
    </div>
