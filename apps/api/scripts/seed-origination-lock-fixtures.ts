...
const FIXTURES: FixtureSpec[] = [
  ...
  },
  {
    key: "B5",
    cases: "B5",
    what: "Facility approved, invoice pending withdraw",
    structure: "new_contract",
  ...
  },
  {
    ...
    what: "Completed with one approved invoice",
    structure: "new_contract",
    appStatus: "COMPLETED",
    contractStatus: "APPROVED",
  ...
  },
  {
    key: "B7",
    cases: "B7",
    what: "Invoice-only offer sent, withdraw invoice",
  ...
  },
  {
    key: "B8",
    cases: "B8",
    what: "Invoice-only, withdraw closes application",
    structure: "invoice_only",
    appStatus: "INVOICE_PENDING",
    contractStatus: "SUBMITTED",
    invoiceStatuses: ["SUBMITTED"],
  ...
  },
  {
    key: "L1",
    cases: "Legacy",
    what: "Grandfather file with two invoices (cannot add more)",
    structure: "new_contract",
    appStatus: "SUBMITTED",
    contractStatus: "SUBMITTED",
