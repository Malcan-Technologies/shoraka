...
describe("admin Paymaster registry list", () => {
  ...
  it("does not introduce a new Paymaster identity notification or audit event", () => {
    ...
    expect(identities).not.toMatch(/PAYMASTER_CREATED|PAYMASTER_LINKED_TO_ISSUER|PAYMASTER_IDENTITY_UPDATED|PAYMASTER_VERIFIED|PAYMASTER_IDENTITY_SYNCED|PAYMASTER_IDENTITY_RESOLVED/);
