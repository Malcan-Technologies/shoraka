...
export enum ApplicationLogEventType {
  ...
  PAYMASTER_IDENTITY_UPDATED = "PAYMASTER_IDENTITY_UPDATED",
  PAYMASTER_VERIFIED = "PAYMASTER_VERIFIED",
  PAYMASTER_IDENTITY_SYNCED = "PAYMASTER_IDENTITY_SYNCED",
  PAYMASTER_IDENTITY_RESOLVED = "PAYMASTER_IDENTITY_RESOLVED",
  FINANCIAL_FIELD_UPDATED = "FINANCIAL_FIELD_UPDATED",
  FINANCIAL_YEAR_ADDED = "FINANCIAL_YEAR_ADDED",
  CTOS_FINANCIAL_STATEMENT_BECAME_AVAILABLE = "CTOS_FINANCIAL_STATEMENT_BECAME_AVAILABLE",
}
