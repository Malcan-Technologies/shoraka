...
/**
 * Base webhook handler with common signature verification logic
 */
export abstract class BaseWebhookHandler {
  protected config = getRegTankConfig();
  ...
  async processWebhook(
    ...
    // Process webhook (implemented by subclasses)
  ...
  /**
   * Get webhook type name for logging
   */
  protected abstract getWebhookType(): string;

  /**
   * Handle the webhook payload (implemented by subclasses)
   */
