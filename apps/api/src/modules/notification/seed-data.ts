...
export const initialNotificationTypes = [
  ...
  {
    id: "note_campaign_extended_issuer",
    name: "Campaign extended",
    description: "The funding period for a published note was extended.",
    category: NotificationCategory.SYSTEM,
    portal_targets: ISSUER_ONLY,
    default_priority: NotificationPriority.INFO,
    user_configurable: true,
  ...
  {
    id: "note_campaign_extended_investor",
    name: "Listing deadline extended",
    description: "The listing deadline was extended on a note you have committed to.",
    category: NotificationCategory.SYSTEM,
    portal_targets: INVESTOR_ONLY,
    default_priority: NotificationPriority.INFO,
    user_configurable: true,
  ...
  {
    id: "note_repayment_due_soon",
    name: "Repayment due soon",
    description: "Reminder that a note repayment is due in 7 days or tomorrow.",
    category: NotificationCategory.SYSTEM,
    portal_targets: ISSUER_ONLY,
    default_priority: NotificationPriority.INFO,
    user_configurable: true,
  ...
  },
  {
    id: "note_overdue",
    name: "Note overdue",
    description: "A note payment is past due and still inside the grace period.",
    category: NotificationCategory.SYSTEM,
    portal_targets: ISSUER_ONLY,
    default_priority: NotificationPriority.WARNING,
    user_configurable: true,
  ...
  },
  {
    id: "note_late",
    name: "Note late",
    description: "A note payment is past the grace period.",
    category: NotificationCategory.SYSTEM,
    portal_targets: ISSUER_ONLY,
    default_priority: NotificationPriority.WARNING,
    user_configurable: true,
  ...
  {
    id: "note_late_investor",
    name: "Note late",
    description: "A note you invested in is past the grace period.",
    category: NotificationCategory.SYSTEM,
    portal_targets: INVESTOR_ONLY,
    default_priority: NotificationPriority.WARNING,
    user_configurable: true,
  ...
  },
  {
    ...
    description: "Sent when a deposit has been credited to your wallet.",
    category: NotificationCategory.SYSTEM,
    portal_targets: INVESTOR_ONLY,
    default_priority: NotificationPriority.INFO,
    user_configurable: true,
  ...
  {
    id: "investment_committed",
    name: "Investment committed",
    description: "Sent when you successfully commit funds to a note.",
    category: NotificationCategory.SYSTEM,
    portal_targets: INVESTOR_ONLY,
    default_priority: NotificationPriority.INFO,
    user_configurable: true,
  ...
  {
    id: "investor_withdrawal_submitted",
    name: "Withdrawal submitted",
    description: "Sent when your cash withdrawal request has been submitted for processing.",
    category: NotificationCategory.SYSTEM,
    portal_targets: INVESTOR_ONLY,
    default_priority: NotificationPriority.INFO,
    user_configurable: true,
  ...
  {
    id: "investor_withdrawal_completed",
    name: "Withdrawal completed",
    description: "Sent when your cash withdrawal has been completed.",
    category: NotificationCategory.SYSTEM,
    portal_targets: INVESTOR_ONLY,
    default_priority: NotificationPriority.INFO,
    user_configurable: true,
