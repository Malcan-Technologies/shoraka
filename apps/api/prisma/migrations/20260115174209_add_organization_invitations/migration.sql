-- AlterEnum: Update OrganizationMemberRole enum
...
-- Migrate existing data: OWNER -> ORGANIZATION_ADMIN
UPDATE "organization_members" 
SET role = 'ORGANIZATION_ADMIN'::"OrganizationMemberRole"
WHERE role = 'OWNER'::"OrganizationMemberRole";

-- Migrate existing data: DIRECTOR -> ORGANIZATION_MEMBER
UPDATE "organization_members" 
SET role = 'ORGANIZATION_MEMBER'::"OrganizationMemberRole"
WHERE role = 'DIRECTOR'::"OrganizationMemberRole";

-- Migrate existing data: MEMBER -> ORGANIZATION_MEMBER
UPDATE "organization_members" 
SET role = 'ORGANIZATION_MEMBER'::"OrganizationMemberRole"
WHERE role = 'MEMBER'::"OrganizationMemberRole";
