...
ALTER TABLE "site_documents"
  ...
  ADD COLUMN IF NOT EXISTS "status" "LegalDocumentStatus" NOT NULL DEFAULT 'PUBLISHED',
  ...
  ADD COLUMN IF NOT EXISTS "open_before_accept_required" BOOLEAN NOT NULL DEFAULT false,
