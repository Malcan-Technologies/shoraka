...
async function main() {
  ...
  logger.info("🌱 Seeding remaining application data...");
  // ---------------------------------------------------------------------------
  ...
  if (!existingRayBanOrg) {
    ...
    logger.info("✅ Ray Ban Sdn Bhd organization seeded with full JSON data");
  } else {
  ...
  if (!existingYzOrg) {
    ...
    logger.info("✅ Yuen Zheng Chng personal investor seeded with full JSON data");
  } else {
  ...
  if (!existingTestedOrg) {
    ...
    logger.info("✅ 'tested' company investor seeded with full corporate data");
  } else {
