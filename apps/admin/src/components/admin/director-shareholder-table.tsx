...
import { RegtankRecordsControl } from "./regtank-records-control";
...
function mergePeopleRowsByMatchKey(rows: ApplicationPersonRow[]): ApplicationPersonRow[] {
  ...
  for (const row of rows) {
    ...
    map.set(key, {
      ...
      onboarding: pickPreferredDirectorShareholderOnboarding(prev.onboarding, row.onboarding),
      screening: pickPreferredDirectorShareholderScreening(prev.screening, row.screening),
