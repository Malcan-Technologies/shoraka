  ...
  return {
    ...
    target: {
      ...
      extra: presentFields([
        ...
        { label: "Certificate number", value: pickString(metadata, ["certificateNumber"]) },
        { label: "Receipt number", value: pickString(metadata, ["receiptNumber"]) },
        { label: "Version", value: pickString(metadata, ["version"]) },
        { label: "Previous version", value: pickString(metadata, ["previousVersion"]) },
        { label: "New version", value: pickString(metadata, ["newVersion"]) },
    ...
    technical: presentFields([
      ...
      { label: "Snapshot SHA-256", value: pickString(metadata, ["snapshotSha256"]) },
      { label: "Old snapshot SHA-256", value: pickString(metadata, ["oldSnapshotSha256"]) },
      { label: "New snapshot SHA-256", value: pickString(metadata, ["newSnapshotSha256"]) },
      { label: "Admin PDF SHA-256", value: pickString(metadata, ["adminPdfSha256"]) },
      { label: "PDF SHA-256", value: pickString(metadata, ["pdfSha256"]) },
    ]),
    metadata,
    previousValues: previous,
    nextValues: next,
