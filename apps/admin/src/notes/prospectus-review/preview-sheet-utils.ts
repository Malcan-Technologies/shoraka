...
/**
 * Document frame: horizontal overflow only.
 * Vertical scrolling belongs to the iframe document.
 */
export const PREVIEW_DOCUMENT_FRAME_CLASS =
  "mx-auto block h-full w-full max-w-[210mm] overflow-x-auto overflow-y-hidden overscroll-contain rounded-xl border bg-white shadow-sm";

export const PREVIEW_IFRAME_CLASS =
  "block h-full w-full min-h-0 border-0 bg-white";
