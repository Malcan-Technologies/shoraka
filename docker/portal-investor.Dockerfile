...
RUN rm -rf apps/investor/.next && \
    ...
    echo "NEXT_PUBLIC_PLAIN_CHAT_APP_ID=${NEXT_PUBLIC_PLAIN_CHAT_APP_ID}" >> apps/investor/.env.production && \
    echo "NEXT_PUBLIC_HELP_CENTER_URL=${NEXT_PUBLIC_HELP_CENTER_URL}" >> apps/investor/.env.production && \
